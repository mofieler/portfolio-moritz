import { defineComponent, computed, unref, mergeProps, ref, withCtx, createTextVNode, toDisplayString, readonly, renderSlot, toValue, watch, useSSRContext } from 'file://C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderAttr, ssrRenderClass, ssrRenderSlot, ssrRenderTeleport } from 'file://C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { _ as __nuxt_component_0$3 } from './nuxt-link-BEwqaDiO.mjs';
import { p as publicAssetsURL } from '../_/nitro.mjs';
import { u as useI18n, a as useRuntimeConfig } from './server.mjs';
import { u as useSmoothScroll, a as useLenis } from './useSmoothScroll-Cw9Vktc0.mjs';
import { _ as _sfc_main$l } from './UiIcon-CWWqmf7-.mjs';
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const PHRASES = {
      ...
      de: ["der Interaktion.", "der Digitalisierung.", "der Mobilit\xE4t.", "des Erlebnisses.", "von morgen."]
    };
    ...
    computed(() => {
      var _a;
      return (_a = PHRASES[locale.value]) != null ? _a : PHRASES.en;
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(TECH_STACK, (tech, i) => {
        ...
        if (i < TECH_STACK.length - 1) {
          _push(`<span class="text-brand-muted/30 text-[10px] mx-1 select-none" data-v-863bcd08>\xB7</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
...
function useTranslatedProject(projectRef) {
  ...
  const pick = (key, fallback) => key ? t(key) : fallback != null ? fallback : "";
  return {
    category: computed(() => {
      var _a, _b;
      return pick((_a = project.value) == null ? void 0 : _a.categoryKey, (_b = project.value) == null ? void 0 : _b.category);
    }),
    title: computed(() => {
      var _a, _b;
      return pick((_a = project.value) == null ? void 0 : _a.titleKey, (_b = project.value) == null ? void 0 : _b.title);
    }),
    description: computed(() => {
      var _a, _b;
      return pick((_a = project.value) == null ? void 0 : _a.descriptionKey, (_b = project.value) == null ? void 0 : _b.description);
    }),
    longDescription: computed(() => {
      var _a, _b;
      return pick((_a = project.value) == null ? void 0 : _a.longDescriptionKey, (_b = project.value) == null ? void 0 : _b.longDescription);
    }),
    imageAlt: computed(() => {
      var _a, _b;
      return pick((_a = project.value) == null ? void 0 : _a.imageAltKey, (_b = project.value) == null ? void 0 : _b.imageAlt);
    }),
    imageAlt2: computed(() => {
      var _a, _b;
      return pick((_a = project.value) == null ? void 0 : _a.imageAlt2Key, (_b = project.value) == null ? void 0 : _b.imageAlt2);
    }),
    tags: computed(() => {
      var _a, _b, _c;
      const key = (_a = project.value) == null ? void 0 : _a.tagsKey;
      if (key) {
        const list = tm(key);
        if (Array.isArray(list)) return list.map((item) => rt(item));
      }
      return (_c = (_b = project.value) == null ? void 0 : _b.tags) != null ? _c : [];
    }),
    features: computed(() => {
      var _a, _b, _c;
      const key = (_a = project.value) == null ? void 0 : _a.featuresKey;
      if (key) {
        const list = tm(key);
        if (Array.isArray(list)) return list;
      }
      return (_c = (_b = project.value) == null ? void 0 : _b.features) != null ? _c : [];
    })
  };
}
function useTranslatedSkill(skillRef) {
  ...
  return {
    title: computed(() => {
      var _a;
      return skill.value.titleKey ? t(skill.value.titleKey) : (_a = skill.value.title) != null ? _a : "";
    }),
    description: computed(
      () => {
        var _a;
        return skill.value.descriptionKey ? t(skill.value.descriptionKey) : (_a = skill.value.description) != null ? _a : "";
      }
    ),
    tags: computed(() => {
      var _a;
      ...
      if (key) {
        ...
        if (Array.isArray(labels)) {
          return labels.map((label, i) => {
            ...
            return {
              label: rt(label),
              variant: (_c = (_b = (_a2 = skill.value.tags) == null ? void 0 : _a2[i]) == null ? void 0 : _b.variant) != null ? _c : "neutral"
            };
          });
        }
      }
      return (_a = skill.value.tags) != null ? _a : [];
    })
  };
}
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getTagVariant = (tag) => {
      var _a;
      return (_a = tagVariants[tag]) != null ? _a : "neutral";
    };
    const props = __props;
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const total = computed(() => {
      var _a, _b;
      return (_b = (_a = props.gallery) == null ? void 0 : _a.length) != null ? _b : 0;
    });
    const hasMany = computed(() => total.value > 1);
    const hasContent = computed(() => !!props.videoSrc || total.value > 0);
    const activeItem = computed(() => {
      var _a;
      return (_a = props.gallery) == null ? void 0 : _a[activeIndex.value];
    });
    const activeCaption = computed(() => {
      var _a;
      const key = (_a = activeItem.value) == null ? void 0 : _a.captionKey;
      return key ? t(key) : "";
    });
    watch(
      () => props.gallery,
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const label = (feature, key) => {
      ...
      return key === "title" ? (_a = feature.title) != null ? _a : "" : (_b = feature.description) != null ? _b : "";
    };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiIcon = _sfc_main$l;
    ...
    const parsedSections = computed(() => {
      ...
      for (const line of lines) {
        ...
        if (trimmed.startsWith("- ") || trimmed.startsWith("\u2022 ") || trimmed.startsWith("\u2014 ") || trimmed.startsWith("\u2013 ")) {
          ...
          if ((lastSection == null ? void 0 : lastSection.type) === "bullet") {
            sections.push({
              title: "",
              content: trimmed,
              type: "bullet"
      ...
      if (unref(hasLongDesc) && unref(isDescExpanded)) {
        ...
        ssrRenderList(unref(parsedSections), (section, index) => {
          ...
          if (section.type === "heading") {
            ...
            _push(`<div class="case-study-bullet" data-v-e4885244><span class="bullet-marker" data-v-e4885244>\u2014</span><span data-v-e4885244>${(_a = formattedContent(section.content)) != null ? _a : ""}</span></div>`);
          } else {
            _push(`<p class="case-study-paragraph" data-v-e4885244>${(_b = formattedContent(section.content)) != null ? _b : ""}</p>`);
          }
          _push(`<!--]-->`);
        });
        _push(`<!--]--></div>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (__props.isOpen && __props.project) {
          ...
          _push2(ssrRenderComponent(_component_DrawerContent, {
            ...
            "is-switching": (_a = __props.isSwitching) != null ? _a : false
          }, null, _parent));
          _push2(`</div>`);
...
function useProjectDrawer(projects2) {
  ...
  const switchProject = (direction) => {
    ...
    setTimeout(() => {
      var _a;
      const currentIndex = projects2.findIndex((p) => {
        var _a2;
        return p.id === ((_a2 = currentProject.value) == null ? void 0 : _a2.id);
      });
      const delta = direction === "next" ? 1 : -1;
      const newIndex = (currentIndex + delta + projects2.length) % projects2.length;
      currentProject.value = projects2[newIndex];
      isSwitching.value = false;
      (_a = (void 0).querySelector(".drawer-scroll-area")) == null ? void 0 : _a.scrollTo({ top: 0, behavior: "smooth" });
    }, 300);
  };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const pageDescription = computed(
      () => isDE.value ? "Freiberuflicher UX-Stratege und Frontend-Entwickler aus Stuttgart. Von der Nutzerforschung bis zur fertigen L\xF6sung \u2014 modulare, nutzerzentrierte Digital\xADprodukte mit Vue.js, Nuxt und Figma." : "Freelance UX Strategist and Frontend Developer based in Stuttgart, Germany. From research to production \u2014 building modular, user-centred digital products with Vue.js, Nuxt and Figma."
    );
...
//# sourceMappingURL=index-DNNjevMt.mjs.map
