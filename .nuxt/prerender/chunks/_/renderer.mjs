...
import { j as joinRelativeURL, u as useRuntimeConfig, a as useStorage, d as defineRenderHandler, g as getRouteRules, b as joinURL, c as useNitroApp } from './nitro.mjs';
...
import { isRef, toValue } from 'file://C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/vue/index.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"UX Strategist and Frontend Developer creating modular, user-centered digital ecosystems."},{"name":"theme-color","content":"#F9F8F6"},{"property":"og:title","content":"Moritz Fieler | UX Strategy & Implementation"},{"property":"og:description","content":"UX Strategist and Frontend Developer creating modular, user-centered digital ecosystems."},{"property":"og:type","content":"website"},{"property":"og:url","content":"https://moritzfieler.com"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Moritz Fieler | UX Strategy & Implementation","htmlAttrs":{"lang":"en"}};
...
const getServerEntry = () => import('../build/client.precomputed.mjs').then(function (n) { return n.s; }).then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getPrecomputedDependencies = () => import('../build/client.precomputed.mjs').then(function (n) { return n.a; }).then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
