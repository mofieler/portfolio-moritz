import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, ref, unref, computed, Fragment, createVNode, Text, defineAsyncComponent, Suspense, nextTick, mergeProps, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestProtocol } from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, isNavigationFailure, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/defu/dist/defu.mjs";
import { klona } from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/klona/dist/index.mjs";
import { parse as parse$1 } from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/destr/dist/index.mjs";
import { isEqual as isEqual$1 } from "C:/Users/morit/MyCode/moritzfieler.com/frontend/node_modules/ohash/dist/index.mjs";
...
const _routes = [
  {
    name: "index___en",
    path: "/en",
    component: () => import("./_nuxt/index-DNNjevMt.js")
  },
  {
    name: "index___de",
    path: "/",
  ...
  },
  {
    name: "impressum___en",
    path: "/en/impressum",
    component: () => import("./_nuxt/impressum-D1BUFEI9.js")
  },
  {
    name: "impressum___de",
    path: "/impressum",
  ...
  },
  {
    ...
    path: "/en/datenschutz",
    component: () => import("./_nuxt/datenschutz-CW0IklTt.js")
  },
  {
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-DyIrFCPd.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CEthj5Hz.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-m2vr7q6Z.js"));
