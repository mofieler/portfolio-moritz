import { defineComponent, ref, mergeProps, useSSRContext, withCtx, renderSlot, unref, createTextVNode, toDisplayString, computed, toValue, watch, readonly } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrRenderList, ssrRenderTeleport } from "vue/server-renderer";
import { _ as _export_sfc, u as useI18n } from "../server.mjs";
import { _ as __nuxt_component_0$2 } from "./nuxt-link-hCuLLm2X.js";
import { u as useSmoothScroll, _ as _sfc_main$l } from "./useSmoothScroll-D9F-S2zI.js";
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-91dc8466"]]);
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const variantClasses = {
      primary: "bg-brand-text text-white hover:bg-black shadow-md",
      secondary: "bg-white text-brand-text border border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm"
    };
    const sizeClasses = {
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_HeroBackground = __nuxt_component_0$1;
      const _component_UiButton = _sfc_main$j;
      const _component_UiIcon = _sfc_main$l;
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "top",
        class: "relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 flex flex-col items-center justify-center text-center min-h-[95vh]"
      }, _attrs))}>`);
      _push(ssrRenderComponent(_component_HeroBackground, null, null, _parent));
      _push(`<div class="relative z-10 max-w-4xl mx-auto reveal"><span class="eyebrow-text text-brand-terra mb-6 block">${ssrInterpolate(_ctx.$t("hero.eyebrow"))}</span><h1 class="heading-display mb-8">${ssrInterpolate(_ctx.$t("hero.title"))} <br class="hidden md:block"><span class="text-gradient-terra">${ssrInterpolate(_ctx.$t("hero.titleAccent"))}</span></h1><p class="body-large max-w-2xl mx-auto mb-12">${ssrInterpolate(_ctx.$t("hero.description", { name: PERSONAL_NAME }))}</p><div class="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto px-4 sm:px-0">`);
      ...
      _push(`</div></div><div class="absolute z-10 bottom-24 md:bottom-12 animate-bounce text-brand-muted text-xl md:text-2xl">`);
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const variantClasses = {
      neutral: "bg-brand-bg text-brand-text border-gray-100",
...
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative w-full h-full flex items-end justify-center gap-3 md:gap-5 pb-0" }, _attrs))}><img${ssrRenderAttr("src", __props.imageSrc)}${ssrRenderAttr("alt", __props.imageAlt)} loading="lazy" class="w-[42%] md:w-[44%] object-contain object-bottom drop-shadow-2xl select-none pointer-events-none -translate-y-6 group-hover:-translate-y-10 transition-transform duration-700">`);
      if (__props.imageSrc2) {
        _push(`<img${ssrRenderAttr("src", __props.imageSrc2)}${ssrRenderAttr("alt", __props.imageAlt2 || "")} loading="lazy" class="w-[38%] md:w-[40%] object-contain object-bottom drop-shadow-[0_8px_32px_rgba(0,0,0,0.18)] select-none pointer-events-none group-hover:-translate-y-4 transition-transform duration-700 delay-75">`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiIcon = _sfc_main$l;
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "drawer-header" }, _attrs))} data-v-a745c8f5><div class="flex items-center gap-4" data-v-a745c8f5><button class="drawer-pill-btn"${ssrRenderAttr("aria-label", _ctx.$t("drawer.close"))} data-v-a745c8f5>`);
      _push(ssrRenderComponent(_component_UiIcon, {
        name: "X",
        size: "md"
      }, null, _parent));
      _push(`</button><span class="drawer-label" data-v-a745c8f5>${ssrInterpolate(__props.subtitle)}</span></div><nav class="flex items-center gap-2" data-v-a745c8f5><button class="drawer-pill-btn"${ssrRenderAttr("aria-label", _ctx.$t("drawer.prevProject"))} data-v-a745c8f5>`);
      _push(ssrRenderComponent(_component_UiIcon, {
        name: "ChevronLeft",
        size: "md"
      }, null, _parent));
      _push(`</button><button class="drawer-pill-btn"${ssrRenderAttr("aria-label", _ctx.$t("drawer.nextProject"))} data-v-a745c8f5>`);
      _push(ssrRenderComponent(_component_UiIcon, {
        name: "ChevronRight",
        size: "md"
      }, null, _parent));
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-a745c8f5"]]);
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiIcon = _sfc_main$l;
      if (unref(hasContent)) {
        _push(`<div${ssrRenderAttrs(_attrs)} data-v-82007411>`);
        if (__props.videoSrc) {
          _push(`<div class="${ssrRenderClass([__props.accentClass || "stage-default", "video-stage"])}" data-v-82007411><iframe${ssrRenderAttr("src", __props.videoSrc)} class="video-frame" allow="autoplay; fullscreen" allowfullscreen loading="lazy" title="Project video" data-v-82007411></iframe></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(total) > 0) {
          _push(`<div class="${ssrRenderClass({ "mt-8": __props.videoSrc })}" data-v-82007411><div class="${ssrRenderClass([__props.accentClass || "stage-default", "stage group"])}" data-v-82007411><img${ssrRenderAttr("src", __props.gallery[unref(activeIndex)])}${ssrRenderAttr("alt", `${__props.title} — ${unref(activeIndex) + 1} / ${unref(total)}`)} class="stage-image" loading="lazy" data-v-82007411>`);
          if (unref(hasMany)) {
            _push(`<button class="overlay-nav-btn stage-nav stage-nav-prev"${ssrRenderAttr("aria-label", _ctx.$t("drawer.prevImage"))} data-v-82007411>`);
            _push(ssrRenderComponent(_component_UiIcon, {
              name: "ChevronLeft",
              size: "lg"
            }, null, _parent));
          ...
          if (unref(hasMany)) {
            _push(`<button class="overlay-nav-btn stage-nav stage-nav-next"${ssrRenderAttr("aria-label", _ctx.$t("drawer.nextImage"))} data-v-82007411>`);
            _push(ssrRenderComponent(_component_UiIcon, {
              name: "ChevronRight",
              size: "lg"
            }, null, _parent));
          ...
          _push(`<div class="stage-meta" data-v-82007411>`);
          if (unref(hasMany)) {
            _push(`<span class="stage-counter" data-v-82007411>${ssrInterpolate(String(unref(activeIndex) + 1).padStart(2, "0"))} <span class="opacity-40" data-v-82007411>/</span> ${ssrInterpolate(String(unref(total)).padStart(2, "0"))}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<button class="overlay-dark-btn w-9 h-9"${ssrRenderAttr("aria-label", _ctx.$t("drawer.openFullscreen"))} data-v-82007411>`);
          _push(ssrRenderComponent(_component_UiIcon, {
            name: "Expand",
            size: "sm"
          }, null, _parent));
          ...
          if (unref(hasMany)) {
            _push(`<div class="thumb-row" data-v-82007411><!--[-->`);
            ssrRenderList(__props.gallery, (image, index) => {
              _push(`<button class="${ssrRenderClass([{ "thumb-active": index === unref(activeIndex) }, "thumb"])}"${ssrRenderAttr("aria-label", _ctx.$t("drawer.showImage", { n: index + 1 }))} data-v-82007411><img${ssrRenderAttr("src", image)}${ssrRenderAttr("alt", `${__props.title} thumbnail ${index + 1}`)} loading="lazy" data-v-82007411></button>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
        ...
        ssrRenderTeleport(_push, (_push2) => {
          if (unref(isFullscreen) && __props.gallery) {
            _push2(`<div class="lightbox" role="dialog" aria-modal="true" data-v-82007411><button class="lightbox-btn lb-close w-11 h-11"${ssrRenderAttr("aria-label", _ctx.$t("drawer.close"))} data-v-82007411>`);
            ...
            _push2(`</button>`);
            if (unref(hasMany)) {
              _push2(`<button class="lightbox-btn lb-nav lb-nav-prev w-12 h-12 md:w-14 md:h-14"${ssrRenderAttr("aria-label", _ctx.$t("drawer.prevImage"))} data-v-82007411>`);
              _push2(ssrRenderComponent(_component_UiIcon, {
                name: "ChevronLeft",
                size: "lg"
              }, null, _parent));
            ...
            _push2(`<img${ssrRenderAttr("src", __props.gallery[unref(activeIndex)])}${ssrRenderAttr("alt", `${__props.title} — ${unref(activeIndex) + 1}`)} class="lb-image" data-v-82007411>`);
            if (unref(hasMany)) {
              _push2(`<button class="lightbox-btn lb-nav lb-nav-next w-12 h-12 md:w-14 md:h-14"${ssrRenderAttr("aria-label", _ctx.$t("drawer.nextImage"))} data-v-82007411>`);
              _push2(ssrRenderComponent(_component_UiIcon, {
                name: "ChevronRight",
                size: "lg"
              }, null, _parent));
            ...
            if (unref(hasMany)) {
              _push2(`<div class="lb-counter" data-v-82007411>${ssrInterpolate(unref(activeIndex) + 1)} / ${ssrInterpolate(unref(total))}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "empty-state" }, _attrs))} data-v-82007411>`);
        _push(ssrRenderComponent(_component_UiIcon, {
          name: "Photo",
          size: "xl",
          class: "text-gray-400 mb-2"
        }, null, _parent));
        _push(`<p class="text-sm text-gray-500" data-v-82007411>${ssrInterpolate(_ctx.$t("drawer.galleryEmpty"))}</p></div>`);
      }
    };
  }
});
...
const __nuxt_component_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-82007411"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.features.length) {
        _push(`<ul${ssrRenderAttrs(mergeProps({ class: "space-y-4" }, _attrs))} data-v-459775c4><!--[-->`);
        ssrRenderList(__props.features, (feature, index) => {
          _push(`<li class="feature-card" data-v-459775c4><div class="feature-icon" data-v-459775c4>`);
          _push(ssrRenderComponent(_component_UiIcon, {
            name: feature.icon,
            size: "lg"
          }, null, _parent));
          _push(`</div><div data-v-459775c4><h5 class="feature-title" data-v-459775c4>${ssrInterpolate(label(feature, "title"))}</h5><p class="feature-desc" data-v-459775c4>${ssrInterpolate(label(feature, "description"))}</p></div></li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "empty-state" }, _attrs))} data-v-459775c4>`);
        _push(ssrRenderComponent(_component_UiIcon, {
          name: "Star",
          size: "xl",
          class: "text-gray-400 mb-2"
        }, null, _parent));
        _push(`<p class="text-sm text-gray-500" data-v-459775c4>${ssrInterpolate(_ctx.$t("drawer.featuresEmpty"))}</p></div>`);
      }
    };
  }
});
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-459775c4"]]);
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-f5cf68d9><div class="mb-8 md:mb-10 max-w-4xl" data-v-f5cf68d9><span class="project-category" data-v-f5cf68d9>${ssrInterpolate(unref(category))}</span><h3 class="project-title" data-v-f5cf68d9>${ssrInterpolate(unref(title))}</h3><p class="${ssrRenderClass([{ "desc-clamp": unref(isExpandable) && !unref(isDescExpanded) }, "project-description"])}" data-v-f5cf68d9>${ssrInterpolate(unref(description))}</p>`);
      if (unref(hasLongDesc) && unref(isDescExpanded)) {
        _push(`<p class="project-description mt-4" data-v-f5cf68d9>${ssrInterpolate(unref(longDescription))}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(isExpandable)) {
        _push(`<button class="desc-toggle" data-v-f5cf68d9>${ssrInterpolate(unref(isDescExpanded) ? _ctx.$t("drawer.readLess") : _ctx.$t("drawer.readMore"))} `);
        _push(ssrRenderComponent(_component_UiIcon, {
          name: "ChevronDown",
          size: "sm",
      ...
      _push(`</div><section class="mb-12 md:mb-16" data-v-f5cf68d9><div class="section-head" data-v-f5cf68d9><h4 class="section-title" data-v-f5cf68d9>${ssrInterpolate(_ctx.$t("drawer.gallery"))}</h4><span class="section-rule" data-v-f5cf68d9></span></div>`);
      ...
      _push(`</section><section data-v-f5cf68d9><div class="section-head" data-v-f5cf68d9><h4 class="section-title" data-v-f5cf68d9>${ssrInterpolate(_ctx.$t("drawer.features"))}</h4><span class="section-rule" data-v-f5cf68d9></span></div>`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-f5cf68d9"]]);
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiIcon = _sfc_main$l;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bottom-nav-wrapper" }, _attrs))} data-v-b021bff8><nav class="bottom-nav" data-v-b021bff8><button class="nav-btn nav-btn-muted" data-v-b021bff8>`);
      _push(ssrRenderComponent(_component_UiIcon, {
        name: "ArrowLeft",
        size: "sm"
      }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$t("drawer.prev"))}</button><span class="nav-divider" data-v-b021bff8></span><button class="nav-btn nav-btn-strong" data-v-b021bff8>${ssrInterpolate(_ctx.$t("drawer.next"))} `);
      _push(ssrRenderComponent(_component_UiIcon, {
        name: "ArrowRight",
        size: "sm"
      }, null, _parent));
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-b021bff8"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.isOpen && __props.project) {
          _push2(`<div class="drawer-overlay" role="dialog" aria-modal="true" data-v-9f9c0bd1><div class="drawer-backdrop" aria-hidden="true" data-v-9f9c0bd1></div><template><div class="drawer-panel" data-v-9f9c0bd1>`);
          ...
          _push2(`<div class="drawer-scroll-area" data-lenis-prevent data-v-9f9c0bd1>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-9f9c0bd1"]]);
const projects = [
  {
    id: "paquita-pilates",
    num: "01",
    ...
    gallery: [
      "/images/projects/portfolio/paquita/paquita-mobile.png",
      "/images/projects/portfolio/paquita/paquita-mac.png"
    ],
    reversed: false,
  ...
  },
  {
    ...
    gallery: [
      "/images/projects/portfolio/hiqer/hiqer-three.png",
      "/images/projects/portfolio/hiqer/hiqer-quests.png",
      "/images/projects/portfolio/hiqer/hiqer-ranking.png",
      "/images/projects/portfolio/hiqer/hiqer-watch.png"
    ],
    reversed: true,
  ...
  },
  {
    ...
    gallery: [
      "/images/projects/portfolio/kischde/kischde-home.png",
      "/images/projects/portfolio/kischde/kischde-profile.png"
    ],
    reversed: false,
  ...
  },
  {
    ...
    gallery: [
      "/images/projects/portfolio/emobility/main.png",
      "/images/projects/portfolio/emobility/mba_dynamicisland.gif",
      "/images/projects/portfolio/emobility/dashboard.png",
      "/images/projects/portfolio/emobility/charging.png",
      "/images/projects/portfolio/emobility/menu.png"
    ],
    reversed: false,
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiIcon = _sfc_main$l;
      const _component_UiTag = _sfc_main$g;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-brand-surface p-8 md:p-10 rounded-[2rem] shadow-soft border border-gray-100 hover:shadow-hover transition-shadow duration-300" }, _attrs))}><div class="w-12 h-12 md:w-14 md:h-14 bg-brand-bg rounded-2xl flex items-center justify-center text-brand-text mb-6 border border-gray-200/60">`);
      _push(ssrRenderComponent(_component_UiIcon, {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        { name: "description", content: t("hero.description", { name: "Moritz Fieler" }) }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_HeroSection = _sfc_main$i;
...
//# sourceMappingURL=index-BEEWK2ni.js.map
